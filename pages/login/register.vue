<template>
	<view>
		...
		<view class="form re">
			<view class="code">
				<input placeholder="请输入用户名" maxlength="10" v-model="userList.username" placeholder-style="color: rgba(255,255,255,0.8);"/>
			</view>
			<view class="code">
				<input placeholder="请输入手机号" maxlength="11" v-model="userList.phone" placeholder-style="color: rgba(255,255,255,0.8);"/>
			</view>
			<view class="username">
				<view class="get-code" :style="{'color':getCodeBtnColor}" @click.stop="getCode()">{{getCodeText}}</view>
				<input placeholder="请输入验证码" maxlength="6" v-model="code2" placeholder-style="color: rgba(255,255,255,0.8);"/>
			</view>
			<view class="password">
				<input placeholder="请输入密码" maxlength="20" v-model="userList.password" password=true placeholder-style="color: rgba(255,255,255,0.8);"/>
			</view>
			<view class="password">
				<input placeholder="确认密码" maxlength="20" v-model="confirmPwd" password=true placeholder-style="color: rgba(255,255,255,0.8);"/>
			</view>
			<view class="code">
				<input placeholder="请输入邀请码" maxlength="20" v-model="userList.codeName" placeholder-style="color: rgba(255,255,255,0.8);"/>
			</view>
