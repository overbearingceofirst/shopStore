	...
	<view>
		...
		<view class="addr" @tap="selectAddress">
			...
			<view class="right">
				...
				<view class="addres">
					...
					{{address.province+'-'+ address.city+'-'+address.regoin+' '+ address.detailAddress}}
					{{'邮编:' + address.postCode}}
				</view>
			</view>
		</view>
			...
			<view class="row" v-for="(row,index) in buylist" :key="index">
				<view class="goods-info">
					...
					<view class="info">
						...
						<view class="spec">规格:{{row.productAttr | getValue}} 数量:{{row.productQuantity}}</view>
						<view class="price-number">
							<view class="price">￥{{row.productPrice*row.productQuantity}}</view>
		...
		<view class="order">
			<view class="row">
				...
				<view class="right">
					已扣除{{orderMess.promotionAmount}}积分抵扣{{orderMess.integrationAmount|toFixed}}元
				</view>
			</view>
			<view class="row">
				<view class="left">
		...
		<view class="detail">
			...
			<view class="row">
				...
				<view class="content">
					￥+{{orderMess.freightAmount|toFixed}}
				</view>
			</view>
			<view class="row">
				<view class="nominal">
				...
				<view class="content">
					￥-{{orderMess.integrationAmount|toFixed}}
				</view>
			</view>
		</view>
		<view class="blck">
		...
		<view class="footer">
			<view class="settlement">
				<view class="sum">合计:<view class="money">￥{{orderMess.payAmount|toFixed}}</view></view>
